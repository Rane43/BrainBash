 ...
 * FINISH_BTN_ID = "finish-btn"; private static final String FINAL_RESULT_ID =
 * "FinalResult";
 * 
 ...
 * 
 * @Test void successfullyPlayAGame() throws InterruptedException { // Given I
 * am logged in as a quizzer loginHelper.loginAs(Role.ROLE_QUIZZER);
 * 
 ...
 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(QUIZ_ID))).
 * click();
 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(PLAY_BTN_ID)))
 * .click();
 * 
 * // And I answer all the questions (either right or wrong) // Wait until the
 * button containing the text "Berlin" is visible, then click it
 * wait.until(ExpectedConditions.visibilityOfElementLocated(
 * By.xpath("//button[contains(text(), 'Berlin') or contains(text(), '7')]")
 * )).click();
 * 
 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(NEXT_BTN_ID)))
 * .click();
 * 
 ...
 * )).click();
 * 
 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(FINISH_BTN_ID)
 * )).click();
 * 
