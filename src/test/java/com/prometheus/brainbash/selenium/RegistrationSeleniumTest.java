 ...
 * 
 * import com.prometheus.brainbash.model.Role; import
 * com.prometheus.brainbash.test_helper.DatabaseManager;
 * 
 ...
 * "link-to-register"; private static final String USERNAME_FIELD_ID =
 * "register-username"; private static final String PASSWORD_FIELD_ID =
 * "register-password"; private static final String ROLE_DROPDOWN_ID =
 * "register-role"; private static final String REGISTER_BTN_ID =
 * "register-btn"; private static final String ERROR_MESSAGE_ID =
 * "register-error"; private static final String USER_ICON_ID = "user-icon";
 * 
 ...
 * 
 * // And I enter a non-taken username final String username = "newQuizzer";
 ...
 * 
 * // And I click the register button WebElement registerButton =
 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(
 * REGISTER_BTN_ID))); registerButton.click();
 * 
