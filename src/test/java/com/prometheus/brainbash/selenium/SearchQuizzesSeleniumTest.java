 ...
 * 
 * import com.prometheus.brainbash.dao.QuizRepository; import
 * com.prometheus.brainbash.model.AgeRating; import
 * com.prometheus.brainbash.model.DifficultyRating; import
 * com.prometheus.brainbash.model.Quiz; import
 ...
 * Set<Long> actualQuizIds = quizRepo.findBySearch(searchText, difficultyRating,
 * ageRating).stream().map(Quiz::getId).collect(Collectors.toSet());
 * 
