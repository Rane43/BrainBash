 ...
 * final String LOGIN_BTN_ID = "login-btn"; private static final String
 * ERROR_MESSAGE_ID = "login-error"; private static final String USER_ICON_ID =
 * "user-icon";
 * 
 * // DRIVER private static WebDriver driver; private static WebDriverWait wait;
 * 
 ...
 * // ------------- SUCCESSFUL LOGIN ----------------
 * 
 * @Test void successfulLogin() { // Given I am on the login page
 * driver.get(LOGIN_PAGE_URL);
 * 
 * // And I enter a valid username final String username = "testQuizzer";
 ...
 * 
 * // And I click the login button WebElement loginButton =
 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(LOGIN_BTN_ID))
 * ); loginButton.click();
 * 
 * // Then I am redirected to the homepage wait.until((Function<WebDriver,
 * Boolean>) driver -> driver.getCurrentUrl().equals(HOMEPAGE_URL));
 * assertEquals(HOMEPAGE_URL, driver.getCurrentUrl(),
 * "Test quizzer should have been redirected to the homepage");
 * 
 ...
 * // ------------- UNSUCCESSFUL LOGIN ----------------
 * 
 * @Test void unSuccessfulLogin() { // Given I am on the login page
 * driver.get(LOGIN_PAGE_URL);
 * 
 * // And I enter a invalid username final String username = "invalidUsername";
 * WebElement usernameElement =
 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(
 * USERNAME_FIELD_ID))); usernameElement.sendKeys(username);
 * 
 * // And I enter a invalid password final String password =
 * "invalidPassword123!"; WebElement passwordElement =
 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(
 * PASSWORD_FIELD_ID))); passwordElement.sendKeys(password);
 * 
 * // And I click the login button WebElement loginButton =
 ...
 * ); loginButton.click();
 * 
 * // Then an error message appears. final String errorMessage =
 * "Invalid Username or Password"; WebElement errorMessageElement =
 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(
 * ERROR_MESSAGE_ID))); assertEquals(errorMessage,
