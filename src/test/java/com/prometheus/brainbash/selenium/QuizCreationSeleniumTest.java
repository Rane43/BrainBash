 ...
 * org.junit.jupiter.api.TestInstance.Lifecycle; import org.openqa.selenium.By;
 ...
 * 
 * import com.prometheus.brainbash.model.AgeRating; import
 * com.prometheus.brainbash.model.Category; import
 * com.prometheus.brainbash.model.DifficultyRating; import
 * com.prometheus.brainbash.model.Role; import
 * com.prometheus.brainbash.test_helper.DatabaseManager; import
 * com.prometheus.brainbash.test_helper.LoginHelper;
 * 
 ...
 * 
 * @Test void successfullyCreateAGame() throws InterruptedException { // Given I
 * am logged in as a quiz designer loginHelper.loginAs(Role.ROLE_QUIZ_DESIGNER);
 * 
 * // And I am on the homepage (Create your own quiz page is the modal)
 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(
 * OPEN_CREATE_QUIZ_MODAL_BTN_ID))).click();
 * 
 * // When I enter a title final String newTitle = "New Title";
 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(TITLE_INPUT_ID
 * ))).sendKeys(newTitle);
 * 
 * // And I enter a description final String newDescription = "New Description";
 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(
 * DESCRIPTION_INPUT_ID))).sendKeys(newDescription);
 * 
 * // And I choose the category final Category category = Category.ANATOMY;
 ...
 * 
 * // And I choose the difficulty rating final DifficultyRating difficultyRating
 * = DifficultyRating.EASY; Select difficultyRatingDropdown = new
 * Select(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(
 * DIFFICULTY_RATING_DROPDOWN_ID))));
 * difficultyRatingDropdown.selectByValue(difficultyRating.toString());
 * 
 * // And I choose the age rating final AgeRating ageRating =
 * AgeRating.CHILDREN; Select ageRatingDropdown = new
 * Select(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(
 * AGE_RATING_DROPDOWN_ID))));
 * ageRatingDropdown.selectByValue(ageRating.toString());
 * 
 * // And I click “create quiz”
 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(
 * CREATE_QUIZ_BTN_ID))).click();
 * 
 * // Get all quiz cards
 ...
 * card.findElement(By.className("card-body"));
 * 
 * WebElement cardTitle = cardBody.findElement(By.tagName("h5")); String
 * headerText = cardTitle.getText();
 * 
 * WebElement cardText = cardBody.findElement(By.tagName("p")); String
 * paragraphText = cardText.getText();
 * 
